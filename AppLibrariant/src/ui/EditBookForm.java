...
public class EditBookForm extends JFrame {
    ...
    public EditBookForm(BookPreview bookPreview,
                        LibrarianInteractor librarianInteractor,
                        OnRequestCompleteListener listener) {
        this.librarianInteractor = librarianInteractor;
        this.listener = listener;

        optframe = new JFrame("Edit Book");
        ...
        textFields[0].setText(bookPreview.getTitle());
        textFields[1].setText(bookPreview.getAuthor());
        textFields[2].setText(bookPreview.getQuantity()+"");
        ...
        okButton.addActionListener(e -> {
            if (!isEmpty() && checkInput()) {
                ...
                librarianInteractor.updateBook(bookPreview.getId(), bookInfo, listener);
